        ...
        <div class="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
                ...
                <p class="mt-5 text-blue-100 text-lg">
                    ...
                    Data Lengkap Pertanahan Dan Status Sertifikasi Aset Desa
...
<div class="grid md:grid-cols-3 gap-6 mb-12">
    <div data-aos="zoom-in" class="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-[30px] p-8 shadow-lg text-white">
        <div class="text-center">
            <div class="text-4xl font-black">{{ $belumDiproses }}</div>
            <div class="text-sm text-yellow-100 mt-2">Belum Diproses</div>
        </div>
    </div>

    <div data-aos="zoom-in" data-aos-delay="100" class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-[30px] p-8 shadow-lg text-white">
        <div class="text-center">
            <div class="text-4xl font-black">{{ $prosesPensertifikatan }}</div>
            <div class="text-sm text-blue-100 mt-2">Proses Pensertifikatan</div>
        </div>
    </div>

    <div data-aos="zoom-in" data-aos-delay="200" class="bg-gradient-to-br from-green-500 to-green-600 rounded-[30px] p-8 shadow-lg text-white">
        <div class="text-center">
            <div class="text-4xl font-black">{{ $sertifikatTerbit }}</div>
            <div class="text-sm text-green-100 mt-2">Sertifikat Terbit</div>
        </div>
    </div>
</div>
...
<!-- STATISTIK KELURAHAN -->
<div class="mt-12">
    <div data-aos="zoom-in" class="bg-white rounded-[30px] shadow-xl overflow-hidden">
        <div class="bg-gradient-to-r from-purple-900 to-purple-600 text-white px-8 py-5">
            <h3 class="font-bold text-xl">
                📊 Statistik Pertanahan Berdasarkan Kelurahan
            </h3>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead>
                    <tr class="bg-slate-100 text-slate-700">
                        <th class="p-4 text-left font-semibold">Kelurahan</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-slate-50 transition">
                        <td class="p-4 font-medium text-slate-700">{{ $item->kelurahan }}</td>
                        <td class="p-4 text-center font-bold text-purple-900">{{ $item->total }}</td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="2" class="p-8 text-center text-slate-500">Tidak ada data</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
